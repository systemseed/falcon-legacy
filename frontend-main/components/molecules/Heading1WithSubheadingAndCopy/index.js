      ...
      <div className="copy-with-title-and-subtitle">
        ...
        <div className="copy-with-title-and-subtitle__donate-block">
          ...
          <div className="donation-form-short-block">
            <Button color="secondary" size="lg" name="donate" onClick={this.handleSubmit}>{buttonText}</Button>
            ...
            <div className="donate-paypal">
              <Button outline color="grey" name="paypal" onClick={this.handleSubmit}>Paypal</Button>
            </div>
          </div>
        </div>
      </div>
