...
namespace Drupal\falcon_event_codes\Controller;
 ...
 *
 * @package Drupal\falcon_event_codes\Controller
 */
class EventCodeController extends ControllerBase implements ContainerInjectionInterface {
   ...
   *
   * @param \Drupal\falcon_event_codes\Entity\EventCodeInterface $event_code
   *   A Event code  object.
   *
   * @return array
  ...
  public function revisionOverview(EventCodeInterface $event_code) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\falcon_event_codes\EventCodeInterface $revision */
