...
namespace Drupal\falcon_gifts_api;

/**
 * Generic HTTP client for communication between CW backends.
 *
 * TODO: move to falcon_api and make reusable on donations backend.
 *
 * @package Drupal\falcon_gifts_api
 */
class InternalClient {
  ...
  protected function getAuthToken($backend_name, $scope) {
    $state_key = 'falcon_api.auth_token.' . $backend_name;
