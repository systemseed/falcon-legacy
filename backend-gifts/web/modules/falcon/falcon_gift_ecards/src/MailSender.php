...
use Drupal\falcon_gift_ecards\Entity\EcardItem;
...
class MailSender implements MailSenderInterface {
   ...
   *
   * @param \Drupal\falcon_gift_ecards\Entity\EcardItem $ecardItem
  ...
  public function send(EcardItem $ecardItem) {
    ...
    $message = \Drupal::service('plugin.manager.mail')->mail('falcon_gift_ecards', 'ecard_item', $to, $langcode, $params);
    if ($message['result']) {
